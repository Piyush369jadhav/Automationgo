    ...
    >
      <header className="brandbar" id="top-header">
        <div className="brandbar-inner">
          <a href="#/" onClick={(e) => navigate("/", e)} className="wordmark" id="lnk-wordmark">
            Automationgo
          </a>
          <span className="brandbar-tag" id="tag-brand">
      ...
      <main id="home-main">
        <section className="hero" id="sec-hero">
          ...
          <div className="hero-grid" id="grid-asymmetric-hero">
            <div className="hero-text" id="panel-hero-statement">
              <h1 id="hd-hero-statement" className="!mb-6">
                Piyush Jadhav builds automated outbound engines and high-yield operational workflows for B2B teams.
              </h1>
          ...
          <p className="proof-strip text-center" id="txt-proof-sectors">
            Domain Warmup · Cold Outreach Setup · API Integration · Outbound Scaling · Lead Pipes · Partnership Connection · Direct Introductions
          </p>
          
          <p className="memo-link mt-6" id="paragraph-memo-actions">
            <a href="#/memo" onClick={(e) => navigate("/memo", e)} id="lnk-read-memo">
              Read the memorandum →
            </a>
            ...
            <a
              ...
              className="cta-consult animate-pulse cursor-pointer select-none"
  ...
  return (
    ...
    >
      <header className="brandbar" id="memo-header">
        <div className="brandbar-inner">
          <a href="#/" onClick={(e) => navigate("/", e)} className="wordmark" id="lnk-memo-home">
            Automationgo
          </a>
          <span className="brandbar-tag" id="tag-memo-nav">Memorandum · 01</span>
        </div>
      </header>
      ...
      <header className="brandbar" id="research-header">
        <div className="brandbar-inner">
          <span className="wordmark">
            <a href="#/" onClick={(e) => navigate("/", e)} id="lnk-research-home">
              Automationgo
            </a>
          </span>
          <span className="brandbar-tag" id="tag-research-nav">Research Briefing · 01</span>
        </div>
      </header>
